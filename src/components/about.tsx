...
export default function About() {
  return (
    <div className="bg-cradbg flex items-center justify-center rounded-xl px-[80px] py-6 text-white shadow-xl transition-all duration-500 md:flex-col xl:flex-row">
